...
//       <div className="bg-yellow-400 px-4 py-0 text-center text-blue-900 text-sm font-bold hidden md:block">
//         All our products are 30% cheaper than Concrete housing
//       </div>
...
//         {/* Mobile Menu */}
//         {isMobileMenuOpen && (
//           <div className="md:hidden bg-white text-blue-950 px-6 py-4">
